 ...
 *
 *   router.post('/links', validate({ body: createLinksSchema }), controller.createLinks)
 *   router.get('/user/:userId', validate({ params: userIdParamSchema }), controller.getUserLinks)
 */
